...
for(i in 1:2){
  ...
  print(dim(all.m0m3))
  trios=all.m0m3$Trio.Num
  med.types=all.m0m3$Mediation.type
  ...
  write.table(ot1, file = paste0("/mnt/ceph/jarredk/GMACanalysis/master_tables/simulations_","AdiposeSubcutaneous","_m0m3.txt"), 
  ...
  #source("/mnt/ceph/jarredk/GMACanalysis/GMACpostproc.R")
  sim=read.table(file=paste0("/mnt/ceph/jarredk/GMACanalysis/master_tables/simulations_","AdiposeSubcutaneous","_m0m3.txt"), sep="\t", header = T)
  ...
  write.table(sim, file = paste0("/mnt/ceph/jarredk/GMACanalysis/master_tables/simulations_","AdiposeSubcutaneous","_m0m3.txt"), 
              col.names = T, row.names = F, sep = "\t", quote=F)
  ...
  write.csv(output1, file = paste0("/mnt/ceph/jarredk/GMACanalysis/master_tables/TRIOS_imbalanced_genotypes_","AS","_m0m3.csv"), 
            row.names = F)
  ...
  t1=read.csv(file = paste0("/mnt/ceph/jarredk/GMACanalysis/master_tables/TRIOS_imbalanced_genotypes_","AS","_m0m3.csv"))
  ...
  write.csv(t1, file = paste0("/mnt/ceph/jarredk/GMACanalysis/master_tables/TRIOS_imbalanced_genotypes_","AS","_m0m3.csv"), 
            row.names = F)
