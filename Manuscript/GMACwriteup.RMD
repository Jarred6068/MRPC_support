...
#table.pcorM3$abs.diff=abs((table.pcorM3$GMAC.pcor) - (table.pcorM3$ADDIS.pcor))
#table.pcorM3$diff.PCs=table.pcorM3$GMAC.num.pcs - table.pcorM3$ADDIS.num.pcs
#ggplot(data=table.pcorM3, aes(x=abs.diff, fill=1))+geom_density(alpha=0.5, label=FALSE)
#ggplot(data=table.pcorM3, aes(x=diff.PCs, y=abs.diff))+geom_point()

# boxplot(cbind.data.frame(ADDIS=table.pcorM3$ADDIS.pcor,GMAC=table.pcorM3$GMAC.pcor),
#         ylab="Partial Correlation")

# plot(table.pcorM3$GMAC.num.pcs, 
#      table.pcorM3$GMAC.pcor, 
#      pch=21,
#      bg="red",
#      xlim = c(0,40))
# points(table.pcorM3$ADDIS.num.pcs, 
#        table.pcorM3$ADDIS.pcor,
#        pch=21,
#        bg="blue")
# 
# plot(table.pcorM3$GMAC.num.pcs-table.pcorM3$ADDIS.num.pcs,
#      table.pcorM3$GMAC.pcor-table.pcorM3$ADDIS.pcor,
#      xlab = "ADDIS Partial Correlation",
#      ylab = "GMAC Partial Correlation")
#points(table.pcorM0$ADDIS.pcor.cis.trans., 
#     table.pcorM0$GMAC.pcor.cis.trans.,
#     pch=21,
#     bg="blue")
