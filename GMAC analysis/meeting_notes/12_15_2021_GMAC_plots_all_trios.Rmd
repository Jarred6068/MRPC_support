...
kable(cor(trio1922ArT[,1:3]), caption = "Correlations between the molecular phenotypes and the eQTL for trio 1922 from the GTEx tissue Artery Tibial. This is a similar case as Trio 9 AS where the marginal relationship is not representative of the true relationship between the molecular phenotypes resulting in a false negative edge.")
