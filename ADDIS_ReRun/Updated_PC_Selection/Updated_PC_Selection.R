...
for(i in 1:length(tissues.vec)){
  ...
  save(List.significant.asso1.AdiposeSubcutaneous, file=paste0("/mnt/ceph/jarredk/AddisReRunFiles/Updated_PC_Selection/List.significant.asso1.",tissues.vec[i],".RData"))
}
