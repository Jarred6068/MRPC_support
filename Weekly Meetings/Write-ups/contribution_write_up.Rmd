...
$\bullet$ Just as the p-value gives the expected False Positive Rate (FPR) by rejecting any hypotheses with a p-value at or below the FPR, the q-value similarly gives the Postitive False Discovery Rate (pFDR)/type I error by rejecting any hypothesis with a q-value at or below the pFDR
