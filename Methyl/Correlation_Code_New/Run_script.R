...
# If genotype data are not available for chrX and chrY, please remove those two lines.
# 
...
input.location="/mnt/ceph/jarredk/Methyl/Correlation_Code/"
output.location="/mnt/ceph/jarredk/Methyl/cor_Lists_and_Tables/"

#load in search functions:
load(paste(load.location, "functions.Rdata", sep = ""))
#load in Data
# genotype data: a data matrix of ?? rows and ?? cols; TO BE SPECIFIED
genotype_data=loadRData(fileName = paste(load.location, "genofilename", sep = ""))
# genotype meta data: ....; TO BE SPECIFIED
G_metadata=loadRData(fileName = paste(load.location, "fakegenoMeta.Rdata", sep = ""))
# methylation data: a data matrix of ....
# it takes 20 secs to load
