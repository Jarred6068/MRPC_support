...
\hypersetup{
  pdftitle={5/17/2021 GMAC analysis and pvalue plots},
...
\noindent \textbf{(2.)} - We denote the \(j^{th}\) molecular pheonotype
...
\begin{figure}
\centering
\includegraphics{5_17_2021_GMAC_plots_all_trios_files/figure-latex/unnamed-chunk-10-1.pdf}
