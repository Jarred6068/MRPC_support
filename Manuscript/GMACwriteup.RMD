...
sim$TGM.perm.floored=sim$TGM.perm.p
...
h=0.05
G=ggplot(data = sim)+
  geom_point(aes(x=log10(GMAC.Nominal.p), y=log10(sim$Med.pvalue.GMAC), color=colvar))+
  theme(legend.position = "none")+
...
MRPC.class=as.factor(sim$ADDIS.inf.Class)
D=ggplot(data = sim)+
