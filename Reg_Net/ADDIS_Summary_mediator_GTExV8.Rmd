...
BM=read.table(file="C:/Users/Bruin/Documents/GitHub/MRPC_support/Reg_Net/mart_export_merged.txt", sep="\t", header=T)
...
write.csv(mat1, file = paste0(write.path.addis, "pseudogene.comp.wg.csv"), row.names = FALSE)
...
write.csv(mat1, file = paste0(write.path.addis, "protein.coding.comp.wg.csv"), row.names = FALSE)
...
write.csv(mat1, file = paste0(write.path.addis, "lncRNA.comp.wg.csv"), row.names = FALSE)
