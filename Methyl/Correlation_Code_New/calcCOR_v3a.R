...
calc.corsV3=function(mmat=NULL, emat=NULL, gmat=NULL, GMInfo=NULL, GEInfo=NULL, genoInfo=NULL, chrs=NULL, fn=NULL, bp.range=1000000){
  #SYNTAX:
  ...
  for(i in 1:length(chrs)){
    ...
    if(length(snps.in.rangeE)==0){
      ...
      names(init.table)=c("Express_Gene_ID", "SNP_ID", "chr", "coordinate", "Cor", "CountedAllele", "OtherAllele")
