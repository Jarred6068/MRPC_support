...
save(reg.res, file = "/mnt/ceph/jarredk/MRPC_UPDATE/Simulations/Sim_result_Data/M4.reg.res.RData")
save(inf.mods, file = "/mnt/ceph/jarredk/MRPC_UPDATE/Simulations/Sim_result_Data/M4.inf.mods.RData")
...
png("/mnt/ceph/jarredk/MRPC_UPDATE/Simulations/M4_simulation_results.png")
par(mfrow=c(2,2))
