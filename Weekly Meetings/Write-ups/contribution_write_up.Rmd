...
Significant enrichment was defined as an observed probability less than the threshold $\alpha$ taken at the usual level of $\alpha=0.05$. To control for the false detection of significant enrichment, several FWER and FDR corrections were applied to the observed probabilities and these included: Holm-Bonferroni (FWER), Hochberg (FWER), and the BH method (FDR).
