...
trans.med=df$lm1t2$Trans.Gene.ID
cis.med=df$lm1t1$Cis.Gene.ID
...
write.csv(mat1, file = paste0(write.path.lond, "pseudo.comp.wg.trans.csv"), row.names = TRUE)
write.csv(mat2, file = paste0(write.path.lond, "pseudo.comp.wg.cis.csv"), row.names = TRUE)
...
write.csv(mat1, file = paste0(write.path.lond, "prc.comp.wg.trans.csv"), row.names = TRUE)
write.csv(mat2, file = paste0(write.path.lond, "prc.comp.wg.cis.csv"), row.names = TRUE)
...
write.csv(mat1, file = paste0(write.path.lond, "lncRNA.comp.wg.trans.csv"), row.names = TRUE)
write.csv(mat2, file = paste0(write.path.lond, "lncRNA.comp.wg.cis.csv"), row.names = TRUE)
