...
\end{tikzpicture}
\end{center}
\caption{Example of the network among T-nodes where after \textbf{Step 2} in the \textbf{General Algorithm} we have two undirected edges in the graph $G(T_1, T_2, T_3)$. Without any additional information we can only unqiuely infer if the trio is M2 (see \textbf{Figure 2})}
\end{figure}
