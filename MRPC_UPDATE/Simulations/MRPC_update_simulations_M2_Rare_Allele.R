...
save(reg.res, file = "/mnt/ceph/jarredk/MRPC_UPDATE/Simulations/Sim_result_Data/M2.reg.res.Rare.Alleles.RData")
save(inf.mods, file = "/mnt/ceph/jarredk/MRPC_UPDATE/Simulations/Sim_result_Data/M2.inf.mods.Rare.Alleles.RData")
...
png("/mnt/ceph/jarredk/MRPC_UPDATE/Simulations/M2_simulation_results_Rare_Alleles.png")
par(mfrow=c(2,2))
