...
\caption{Correlations between the molecular phenotypes and the eQTL for
trio 9 from the GTEx tissue Adipose Subcutaneous. Notice that the
correlation between the cis and trans gene is quite weak despite an
obvious within-genotype correlation between the two molecular
phenotypes. Thus MRPC removes this edge in the marginal tests despite
being clearly supported in the higher order conditional
tests.}\tabularnewline
\toprule
& cis.gene & trans.gene & SNP \\
\midrule
\endfirsthead
\toprule
& cis.gene & trans.gene & SNP \\
\midrule
\endhead
cis.gene & 1.0000000 & 0.0680676 & -0.4544867 \\
trans.gene & 0.0680676 & 1.0000000 & 0.7951252 \\
SNP & -0.4544867 & 0.7951252 & 1.0000000 \\
\bottomrule
\end{longtable}
...
\begin{longtable}[]{@{}lrrr@{}}
\caption{Correlations between the molecular phenotypes and the eQTL for
trio 1922 from the GTEx tissue Artery Tibial. This is a similar case as
Trio 9 AS where the marginal relationship is not representative of the
true relationship between the molecular phenotypes resulting in a false
negative edge.}\tabularnewline
\toprule
& cis.gene & trans.gene & SNP \\
\midrule
\endfirsthead
...
\midrule
\endhead
cis.gene & 1.0000000 & 0.0560624 & -0.1992017 \\
trans.gene & 0.0560624 & 1.0000000 & 0.8869496 \\
SNP & -0.1992017 & 0.8869496 & 1.0000000 \\
\bottomrule
\end{longtable}
